...
@Table(
    ...
    indexes = [
        Index(name = "idx_mv_weekly_period_rank", columnList = "period_key, rank_position"),
    ],
    uniqueConstraints = [
        UniqueConstraint(name = "uk_mv_weekly_product_period", columnNames = ["product_id", "period_key"]),
    ],
)
class MvProductRankWeeklyModel internal constructor(
    productId: Long,
    score: Double,
    rankPosition: Int,
    likeCount: Long,
    ...
    companion object {
        ...
        fun create(
            ...
            salesAmount: Long,
            periodKey: String,
        ): MvProductRankWeeklyModel {
            return MvProductRankWeeklyModel(
                productId = productId,
                score = score,
